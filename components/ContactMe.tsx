            ...
            <div className='flex flex-col space-y-10'>
                ...
                <div className='space-y-10'>
                    <div className='flex items-center space-x-5 justify-center'>
                        <PhoneIcon className='text-[#CC8D3B] h-7 w-7 animate-pulse' />
                        <p className='text-2xl'>+47 467 48 737</p>
                    </div>


                    <div className='flex items-center space-x-5 justify-center'>
                        <EnvelopeIcon className='text-[#CC8D3B] h-7 w-7 animate-pulse' />
                        <p className='text-2xl'>camilla.reppen88@gmail.com</p>
                    </div>

                    <div className='flex items-center space-x-5 justify-center'>
                        <MapPinIcon className='text-[#CC8D3B] h-7 w-7 animate-pulse' />
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-2 w-fit mx-auto'>
                    ...
                    <button type="submit" className='bg-[#C7893F] py-5 px-10 rounded-md text-black font-bold text-lg'>Send</button>
